<?php 
	...
	require_once dirname(__FILE__) . '/sdk/Velocity/Connection.php';
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#process-payment-btn").click(function(){
                    ...
                    Velocity.tokenizeForm(sessionToken, card, address, applicationprofileid, merchantprofileid, workflowid, isTestAccount, responseHandler);
                    return false;
                });
